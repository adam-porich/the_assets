...
export const api = {
  ...
  createProduction: (source_ids: string[], pipeline_id: string, consent = false, prompt_override?: string) => request<{ batch: ProductionBatch }>("/production", json("POST", { source_ids, pipeline_id, consent, prompt_override })),
