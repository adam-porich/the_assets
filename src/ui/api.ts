...
export const api = {
  ...
  createProduction: (source_ids: string[], style_version_id: string, consent = false) => request<{ batch: ProductionBatch }>("/production", json("POST", { source_ids, style_version_id, consent })),
